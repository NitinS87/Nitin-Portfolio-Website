...
const NavBar = () => {
  ...
  return (
    <header className="w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8">
      <button className="flex-col justify-center hidden lg:flex" onClick={handleClick}>
        <span className={`bg-dark dark:bg-light transition-all duration-300 ease-out block 
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <div className="flex justify-center items-center flex-wrap">
          <motion.a
            href="https://twitter.com/NitinS243"
            target={"_blank"}
            whileHover={{ y: -2 }}
            className="w-6 mr-3"
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            href="https://linkedin.com/in/nitins9868"
            target={"_blank"}
            whileHover={{ y: -2 }}
            className="w-6 mx-3"
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            href="https://pinterest.com/nitins9868"
            target={"_blank"}
            whileHover={{ y: -2 }}
          ...
          <motion.a
            href="https://dribbble.com/NitinS87"
            target={"_blank"}
            whileHover={{ y: -2 }}
            className="w-6 ml-3"
            whileTap={{ scale: 0.9 }}
      ...
      {isOpen ?
        <motion.div initial={{ scale: 0, opacity: 1, x: "-50%", y: "-50%" }} animate={{ scale: 1, opacity: 1 }} className="min-w-[70vw] flex flex-col justify-between items-center z-30 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32">
